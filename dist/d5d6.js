...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, spl_token_1.mintTo)(connection, poolFee, mintA, tokenAAccount.address, poolFee, 700000000 // because decimals for the mint are set to 5 => 4000
    );
    /*await mintToChecked(
        connection,
        poolFee,
    ...
    console.log(`Token A amount in the pool befroe swaping: ${(yield connection.getTokenAccountBalance(tokenAAccount.address)).value.amount}`);
    //mint token B
    ...
    yield (0, spl_token_1.mintTo)(connection, poolFee, mintB, tokenBAccount.address, poolFee, 600000000 // because decimals for the mint are set to 6 => 700
    );
    /* console.log("Mint B balance: ", mintBInfo.supply);
    console.log("Token B account balance: ", tokenBAccountInfo); */
    console.log(`Token B amount in the pool befroe swaping: ${(yield connection.getTokenAccountBalance(tokenBAccount.address)).value.amount}`);
    ...
    console.log(`Token A amount in the pool after swaping: ${(yield connection.getTokenAccountBalance(tokenAAccount.address)).value.amount}`);
